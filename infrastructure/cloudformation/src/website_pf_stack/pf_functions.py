...
class WebsitePfPoetryLambdaLayer:
    ...
    def __init__(
        self, scope: Construct, construct_id: str, config: Config, override_properties: dict = {}, pyproject_toml_dir: str = "", **kwargs
    ):
        ...
        properties = {
            ...
            "code": aws_lambda.Code.from_asset(pyproject_toml_dir, bundling=bundling_options),
        }

        utils.update_dictionaries(properties, override_properties)
        self.layer = LayerVersion(scope, construct_id, **properties)
...
class WebsitePfLambdaFunction:
    ...
    def __init__(self, scope: Construct, construct_id: str, config: Config, override_properties: dict = {}, **kwargs):
        ...
        utils.update_dictionaries(properties, override_properties)
        self.function = Function(scope, construct_id, **properties)
...
def website_pf_api_lambda(scope: Construct, construct_id: str, config: Config, **kwargs) -> WebsitePfLambdaFunction:
    ...
    log_group_properties = {"log_group_name": f"/aws/lambda/{config.website_pf_api_lambda_name}"}
...
def website_pf_post_loader_lambda(scope: Construct, construct_id: str, config: Config, **kwargs) -> WebsitePfLambdaFunction:
    ...
    log_group_properties = {"log_group_name": f"/aws/lambda/{config.website_pf_loader_lambda_name}"}
